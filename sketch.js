...
function preload(){
  ...
  eggImg = loadAnimation("Images/Placeholder_Eggbot0.png");
  leafImg = loadAnimation("Images/Placeholder_Leaf0.png");
  icicleImg = loadAnimation("Images/Placeholder_Icicle0.png");
...
function setup() {
  ...
  frostbird.addAnimation("normal",birdImg);
  frostbird.scale = 0.5;
  ...
  frostbird2.addAnimation("normal",birdImg);
  ...
  frostbird3.addAnimation("normal",birdImg);
...
function draw() {
  ...
  textSize(10);
  text("Position X :" + player.x,player.x - 100,player.y-190);

  textSize(10);
  text("Position Y :" + player.y,player.x + 100,player.y - 190);
  if(gameState==="play"){
  ...
  if(gameState === "win"){
    textSize(100);
    fill("BLACK");
    text("YOU WIN!!",player.x - 300,player.y - 100);
